// =============================================================================
// SITEMAP DATA - CONTROL DE PLAGAS
// =============================================================================
// Control de plagas profesional en España - 8118 municipalities
// =============================================================================
...
// =============================================================================
// HIGH-INTENT KEYWORD MODIFIERS - Sector Control de Plagas
// =============================================================================
export const MODIFIERS = [
  "",
  // ============ PRECIO / PRESUPUESTO ============
  "-precios", "-barato", "-economico", "-cuanto-cuesta",
  "-presupuesto", "-presupuesto-gratis",

  // ============ URGENCIA / VELOCIDAD ============
  "-urgente", "-24-horas", "-emergencia", "-rapido",
  "-hoy", "-inmediato", "-fin-de-semana",

  // ============ CALIDAD / REPUTACION ============
  "-mejor", "-profesional", "-certificado", "-de-confianza",
  "-mejor-valorado", "-recomendado", "-garantizado",
  "-con-garantia", "-homologado",

  // ============ TIPO DE SERVICIO ============
  "-a-domicilio", "-empresa", "-servicio",
  "-integral", "-completo", "-definitivo",

  // ============ METODO ============
  "-sin-quimicos", "-ecologico", "-con-gel",
  "-con-cebo", "-con-trampas", "-sin-veneno",
  "-tratamiento-termico",

  // ============ UBICACIÓN ============
  "-cerca-de-mi", "-en-mi-zona",

  // ============ TIPO INMUEBLE ============
  "-en-casa", "-en-piso", "-en-local",
  "-en-restaurante", "-en-comunidad", "-en-nave",
  "-en-hotel", "-en-oficina", "-en-jardin",
] as const;

export type Modifier = typeof MODIFIERS[number];

// =============================================================================
// NECESIDADES / PROBLEMAS POR SERVICIO - ALTA INTENCION
// =============================================================================
export const PROBLEMS: Record<Service, readonly string[]> = {
  "desratizacion": [
    "ratas-en-casa", "ratas-en-cocina", "ratones-en-paredes",
    "ratones-en-techo", "ratas-en-garaje", "ratas-en-jardin",
    "ratas-en-restaurante", "ratas-en-comunidad", "ratas-en-alcantarillado",
    "excrementos-raton", "ruidos-en-techo-noche", "ratas-en-sotano",
    "roedores-en-nave", "ratas-en-tejado", "plaga-ratones",
  ],
  "desinsectacion": [
    "plaga-insectos", "insectos-en-casa", "bichos-en-cocina",
    "insectos-voladores", "insectos-rastreros", "bichos-en-bano",
    "insectos-en-madera", "bichos-negros-cocina", "bichos-humedad",
    "insectos-en-despensa", "plaga-bichos",
  ],
  "fumigacion": [
    "fumigar-casa", "fumigar-local", "fumigar-nave",
    "fumigar-restaurante", "fumigar-comunidad", "fumigar-garaje",
    "fumigar-trastero", "fumigar-jardin", "fumigar-sotano",
    "fumigar-oficina", "fumigar-hotel", "fumigar-bar",
  ],
  "control-cucarachas": [
    "cucarachas-cocina", "cucarachas-bano", "plaga-cucarachas",
    "cucarachas-comunidad", "cucarachas-restaurante", "cucarachas-alcantarillado",
    "cucarachas-de-noche", "cucarachas-pequenas", "cucarachas-grandes",
    "cucaracha-alemana", "cucaracha-oriental", "cucarachas-en-tuberias",
    "nido-cucarachas", "cucarachas-en-cocina-electrica",
  ],
  "control-termitas": [
    "termitas-madera", "termitas-muebles", "carcoma",
    "carcoma-vigas", "termitas-marco-puerta", "termitas-parquet",
    "termitas-techo", "polilla-madera", "agujeros-madera",
    "serrín-madera", "termitas-subterraneas", "termitas-tarima",
    "tratamiento-madera", "xilofagos",
  ],
  "control-chinches": [
    "chinches-cama", "chinches-colchon", "chinches-hotel",
    "picaduras-chinches", "chinches-ropa", "chinches-sofa",
    "chinches-maleta-viaje", "chinches-piso-alquiler",
    "manchas-sangre-sabanas", "picaduras-noche", "chinches-resistentes",
    "chinches-habitacion",
  ],
  "eliminar-avispas": [
    "nido-avispas", "avispas-en-tejado", "avispas-en-ventana",
    "avispas-en-jardin", "avispa-asiatica", "avispas-en-persiana",
    "avispas-en-fachada", "avispero-en-arbol", "avispas-en-piscina",
    "avispa-velutina", "avispas-en-chimenea",
  ],
  "control-hormigas": [
    "hormigas-cocina", "hormigas-jardin", "plaga-hormigas",
    "hormigas-en-casa", "hormigas-con-alas", "hormigas-negras",
    "hormigas-rojas", "hormiguero-en-pared", "hormigas-en-terraza",
    "hormigas-en-macetas", "hormiga-argentina",
  ],
  "control-pulgas": [
    "pulgas-en-casa", "pulgas-perro", "pulgas-gato",
    "pulgas-en-cama", "pulgas-en-sofa", "pulgas-en-alfombra",
    "picaduras-pulgas", "plaga-pulgas", "pulgas-sin-mascota",
    "pulgas-en-jardin",
  ],
  "control-mosquitos": [
    "mosquitos-en-casa", "mosquitos-jardin", "mosquito-tigre",
    "plaga-mosquitos", "mosquitos-piscina", "mosquitos-terraza",
    "mosquitos-de-noche", "mosquitos-en-sotano", "larvas-mosquitos",
  ],
  "control-palomas": [
    "palomas-en-balcon", "palomas-en-tejado", "palomas-en-fachada",
    "excrementos-palomas", "palomas-en-patio", "palomas-en-aire-acondicionado",
    "palomas-en-ventana", "plaga-palomas", "nido-palomas",
    "palomas-en-comunidad",
  ],
  "desinfeccion": [
    "desinfectar-local", "desinfectar-oficina", "desinfeccion-legionella",
